...
The course helps students transform an existing industrial design project into two connected deliverables:

1. **Technical Report**  
   A report for production and manufacturing. It should explain how the product could be made, assembled, validated, maintained, and improved.

2. **Visual / Commercial Report**  
   A user-facing report or digital experience. It should explain how the product can be shown, understood, desired, and purchased through a website, landing page, shopping page, app, configurator, or similar format.
...
- [Robust Design and Product Specification Course Structure](Robust%20Design%20and%20Product%20Specification%20Course%Plan.pdf)
